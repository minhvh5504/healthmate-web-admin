...
export function UserTablePagination({ currentPage, totalPages, onPageChange }: UserTablePaginationProps) {
    return (
        <div className="px-6 py-4 flex items-center justify-between mt-2">
            <p className="text-xs text-slate-400">
                Trang <span className="text-slate-700 font-bold ml-1">{currentPage}</span> trong tổng số {totalPages || 1}
            </p>
